        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              <h3 className="font-serif-luxury text-2xl sm:text-3xl text-[#F7F3EC] font-normal">
                {isAr ? 'فريق الضيافة في خدمتكم' : 'At Your Complete Disposal'}
              </h3>
              <p className="text-xs sm:text-sm text-[#D8C7A6]/80 leading-relaxed font-light">
                {isAr
            ...
            {/* Direct Channels */}
            <div className="space-y-6 pt-4 border-t border-[#D8C7A6]/20">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-[#18424a] text-[#B99A5B] border border-[#D8C7A6]/30">
                  <Phone className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-[#D8C7A6]/70 block">{t('phoneLabel')}</span>
                  <a href={`tel:${CONTACT_INFO.phone}`} className="font-serif-luxury text-lg text-white hover:text-[#B99A5B] transition-colors">
                    {CONTACT_INFO.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-[#D8C7A6]/70 block">{t('emailLabel')}</span>
                  <a href={`mailto:${CONTACT_INFO.email}`} className="font-serif-luxury text-lg text-white hover:text-[#B99A5B] transition-colors">
                    {CONTACT_INFO.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-[#D8C7A6]/70 block">Location</span>
            ...
            <div className="pt-6 border-t border-[#D8C7A6]/20">
              <span className="text-[10px] uppercase tracking-widest text-[#D8C7A6]/70 block mb-3">
                {isAr ? 'الملف الإعلامي والتواصل' : 'Press & Social Presence'}
              </span>
              <div className="flex flex-wrap gap-4 text-xs text-[#D8C7A6]">
                {CONTACT_INFO.socials.map((soc, idx) => (
                  <span key={idx} className="px-3 py-1.5 bg-[#18424a] border border-[#D8C7A6]/30 text-white/90">
                    <span className="text-[#B99A5B] font-medium mr-1.5">{soc.name}:</span>
                    {soc.handle}
                  </span>
                ))}
              </div>
          ...
          <div className="lg:col-span-7 bg-[#18424a] border border-[#D8C7A6]/30 p-8 sm:p-10 shadow-2xl">
            {isSubmitted ? (
              <div className="py-12 flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-xs sm:text-sm text-[#D8C7A6] max-w-md leading-relaxed font-light">
                  {t('messageSentSuccess')}
                </p>
                <div className="p-3 bg-black/30 border border-[#D8C7A6]/20 text-[11px] text-[#D8C7A6]/80 max-w-md text-left sm:text-center mt-2">
                  <span className="text-[#B99A5B] font-semibold block mb-0.5">
                ...
                <button
                  type="button"
                  onClick={handleReset}
                  className="mt-6 px-6 py-2.5 bg-transparent border border-[#B99A5B] text-[#D8C7A6] hover:text-white text-xs tracking-widest uppercase transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                <div>
                  <label className="block text-[10px] tracking-[0.2em] uppercase font-semibold text-[#D8C7A6] mb-2">
                    {t('contactName')} *
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-4 py-3 bg-[#12343B]/60 border text-white text-sm focus:outline-none transition-colors ${
                      errors.name ? 'border-red-400' : 'border-[#D8C7A6]/40 focus:border-[#B99A5B]'
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-[#12343B]/60 border text-white text-sm focus:outline-none transition-colors ${
                      errors.email ? 'border-red-400' : 'border-[#D8C7A6]/40 focus:border-[#B99A5B]'
                    }`}
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 bg-[#12343B]/60 border text-white text-sm focus:outline-none transition-colors ${
                      errors.message ? 'border-red-400' : 'border-[#D8C7A6]/40 focus:border-[#B99A5B]'
                    }`}
                  />
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    id="contact-send-btn"
                    className="w-full py-4 bg-[#B99A5B] hover:bg-[#d8c7a6] text-[#12343B] font-semibold text-xs tracking-[0.22em] uppercase transition-all duration-300 hover:shadow-xl flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99]"
                  >
